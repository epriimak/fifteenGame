...
public class GameField {
    ...
    public GameField(String fieldAsString) throws GameFieldException {
        List<List<Integer>> gameFieldAsListOfList = readGameFieldAsListOfList(fieldAsString);
    ...
    private List<List<Integer>> readGameFieldAsListOfList(String field){
        List<String> lines = Arrays.asList(field.split("\n"));
